    ...
    <main className="bg-[#120a06] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-end overflow-hidden pt-16">
        ...
        <div className="relative z-10 container mx-auto px-6 pb-16">
          ...
          <p className="anim-up-4 text-[#E8C9A0]/70 text-lg max-w-xl leading-relaxed">
            An imaginary Taiyaki brand — rebuilt from scratch. Typography research,
            color system and full product mockup. From a 2023 concept to a refined
            2026 identity.
          </p>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-[#C4614A]/15">
            {[
              ...
              { label: "Deliverables",value: "Identity · Mockup"},
            ].map(({ label, value }) => (
      ...
      <section className="py-24 container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <p className="text-[#C4614A] text-xs uppercase tracking-[0.2em] font-semibold mb-4">The Project</p>
            <h2 className="text-3xl md:text-4xl font-bold text-[#F5EDD8] mb-6 leading-tight">
              A brand born<br />from a love of Taiyaki
            </h2>
            <p className="text-[#E8C9A0]/60 leading-relaxed mb-4">
              Lumi started as a personal exploration in 2023 — a fictional Taiyaki brand
              that needed a full visual identity. Three years later, the design was
              completely rebuilt: sharper typography, a more refined color palette, and
              a packaging mockup that feels ready for a real shelf.
            </p>
            <p className="text-[#E8C9A0]/60 leading-relaxed">
              The wordmark uses <span className="text-[#F5EDD8] font-medium">Grandstander</span> — a rounded,
              playful typeface that balances the warmth of a food brand with the energy of
              a modern identity. The palette draws from baked dough, red bean paste, and warm wooden surfaces.
            </p>
          </div>

          {/* Color palette */}
          <div>
            <p className="text-[#C4614A]/60 uppercase tracking-widest text-[10px] mb-6">Color Palette</p>
            <div className="space-y-3">
              {[
                { hex: "#C4614A", name: "Taiyaki Terracotta", role: "Primary" },
                { hex: "#8B3A2A", name: "Red Bean",           role: "Dark accent" },
                { hex: "#6B7C3A", name: "Matcha Olive",       role: "Secondary" },
                { hex: "#D4A024", name: "Sesame Gold",        role: "Highlight" },
                { hex: "#F5EDD8", name: "Dough Cream",        role: "Background" },
              ].map(({ hex, name, role }) => (
      ...
      {/* ── LOGO VARIATIONS — bandeau défilant ───────────────── */}
      <section className="pb-8 overflow-hidden">
        ...
        >
          {[
            ...
            { bg: "/images/Portfolio/lumi/Rectangle 20.png", logo: "/images/Portfolio/lumi/lumi!-2.png", alt: "Lumi yellow"     },
            ...
            { bg: "/images/Portfolio/lumi/Rectangle 20.png", logo: "/images/Portfolio/lumi/lumi!-2.png", alt: "Lumi yellow dup"     },
          ].map(({ bg, logo, alt }, i) => (
            <div
              key={i}
        ...
        <p className="text-center text-[#E8C9A0]/30 text-xs mt-4 tracking-widest uppercase px-6">
          Logo variations — Brand color system
        </p>
      </section>
      ...
      <section className="px-6 pb-8">
        <div className="container mx-auto">
          <div className="relative rounded-2xl overflow-hidden border border-[#C4614A]/15">
            <Image
              src="/images/Portfolio/lumi/Desktop-2.webp"
              alt="Lumi — Brand identity & packaging"
              width={2880}
              height={7566}
          ...
          <p className="text-center text-[#E8C9A0]/30 text-xs mt-4 tracking-widest uppercase">
            Brand board — Typography · Colors · Packaging mockup
          </p>
        </div>
      </section>
      ...
      <section className="py-16 border-t border-[#C4614A]/15">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-[#C4614A]/60 uppercase tracking-widest text-xs">Tools used</p>
