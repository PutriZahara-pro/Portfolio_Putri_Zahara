  ...
  return (
    <main className="container mx-auto px-4 pt-32 pb-12" suppressHydrationWarning>
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">
          The visual style is inspired by the popular animation <strong>Adventure Time</strong>, with its distinctive
          character design and colorful aesthetic. All illustrations were created using <strong>Procreate</strong> and <strong>Photoshop</strong>.
        </p>
