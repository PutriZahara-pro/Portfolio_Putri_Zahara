...
export const characters = {
  ...
  haikal: {
    id: "haikal",
    name: "Prince Haikal",
    image: "/Portfolio_Putri_Zahara/images/characters/haikal_personnage_alone.png",
    stats: {
      hp: 15,
      maxHp: 15,
      attack: 3,
  ...
  milo: {
    ...
    image: "/Portfolio_Putri_Zahara/images/characters/commandant_milo.png",
  ...
  hades: {
    id: "hades",
    name: "Emperor Hades",
    image: "/Portfolio_Putri_Zahara/images/characters/emepror_hades.png",
    stats: {
      hp: 50,
      maxHp: 50,
      attack: 8,
  ...
  ellis: {
    id: "ellis",
    name: "Queen Ellis",
    image: "/Portfolio_Putri_Zahara/images/characters/ellis_queen.png",
    stats: {
      hp: 40,
      maxHp: 40,
      attack: 6,
  ...
  guard: {
    id: "guard",
    name: "Imperial Guard",
    image: "/Portfolio_Putri_Zahara/images/characters/imperial_guard.png",
    stats: {
      hp: 15,
      maxHp: 15,
      attack: 3,
...
export const gameScenes: GameScene[] = [
  ...
  },
  {
    id: "intro_2",
    type: "dialogue",
    background: "/Portfolio_Putri_Zahara/images/title/background.png",
